...
| 2026-07-09-dep-update-tier | dep-update-tier | — | review | 2026-07-09 | Tiered dependency-update process: routine-tier dep-update.md records with a fail-closed diff classifier, check_pins SHA↔tag verification, escalation to full cycles for majors. |
